...
const Forecast = ({ data }) => {
  ...
  return (
    <>
     <div className="flex space-x-4 ml-5 mt-10">
        {data.list.slice(0, 6).map((item, index) => {
          ...
          return (
            <div className="cardContainer" key={index}>
              <div className="card">
                <p className="city">
                 <p className="items-center mt-2">{forecastDays[index]}</p>
                  <label>Humidity | </label>
                  <label>{item.main.humidity}%</label>
                </p>
                <p className="weather mt-2">{item.weather[0].description}</p>
                <svg
                  xmlSpace="preserve"
                  viewBox="0 0 100 100"
                  height="50px"
                ...
                <div className="minmaxContainer">
                  <div className="min">
                    ...
                    <p className="minTemp">{item.main.temp_min}°C</p>
                  </div>
                  <div className="max">
                    <p className="maxHeading">Max</p>
                    <p className="maxTemp">{item.main.temp_max}°C</p>
                  </div>
                </div>
              </div>
            </div>
